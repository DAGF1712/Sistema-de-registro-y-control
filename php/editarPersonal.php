<?php
  ...
  include './conexion.php';
  		  ...
  		  $cedula = $_POST['cedula'];
        $sql="SELECT nombre, apellido, direccion, telefono FROM personal where cedula = '$cedula'";
...
?>
	...
	<div id="formularioRegistro">
		...
		<form id="formulario" name="registroPersonal" action="editarPersonal2.php" method="POST" novalidate>

			<h2 id="tituloRegistro">Editar datos: Personal</h2>
			<br>
          ...
          <div class="inputRegistro">
          	<button type="submit" id="botonRegistrar" onclick="validacionEditarPersonal()"> EDITAR </button>
          </div>
